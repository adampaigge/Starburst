...
yay -S --noconfirm --needed python2 python2-setuptools doxygen-clang cmake libjpeg monado monado-git openhmd-git OpenCV systemd-devel python python3 python-pip libuvc ninja
