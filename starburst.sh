...
sudo pacman -Syu --noconfirm --needed a52dec adobe-source-sans-pro-fonts android-tools avahi base-devel ca-certificates cjson clang cmake curl ecryptfs-utils eigen enchant exfat-utils faac faad2 ffmpeg flac freetype2 fuse-exfat glibc glslang gst-libav gst-plugins-good gstreamer hidapi hunspell-en_US icedtea-web jasper lame languagetool libbsd libdca libdv libdvdcss libdvdnav libdvdread libegl libjpeg libmad libmpeg2 libmythes libtheora libusb libvorbis libx11 libxcb libxcursor libxext libxi libxinerama libxkbcommon-x11 libxrandr libxtst libxv libxxf86vm linux-firmware lsof mythes-en mesa ninja nlohmann-json opencv patch pkg-config pkgconf pkgstats python python-pip python-pipx rsync sdl2 seatd systemd ttf-anonymous-pro ttf-bitstream-vera ttf-dejavu ttf-droid ttf-liberation ttf-ubuntu-font-family unzip v4l-utils wavpack wayland wayland-protocols wget x264 xcb-util xcb-util-cursor xcb-util-image xcb-util-keysyms xcb-util-renderutil xcb-util-wm xcb-util-xrm xf86-video-amdgpu xvidcore
