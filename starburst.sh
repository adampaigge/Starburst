...
sudo pacman -Syu --needed a52dec adobe-source-sans-pro-fonts android-tools aspell-enbase-devel avahi base-devel bluez ca-certificates cjson clang cmake cuda curl doxygen ecryptfs-utils eigen enchant exfat-utils faac faad2 ffmpeg flac font-config freetype2 fuse-exfat git glfw-wayland glibc glslang gst-libav gst-plugins-good gstreamer hidapi hunspell-en_US icedtea-web jasper lame languagetool libbsd libdca libdv libdvdcss libdvdnav libdvdread libegl libglvnd libjpeg libmad libmpeg2 libmythes libopenxr-dev libopenxr-loader1 libopenxr-utils libopenxr1-monado libtheora libusb libvorbis  
